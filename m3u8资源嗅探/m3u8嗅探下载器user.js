...
(function() {
    ...
    class UI {
        ...
        addResource({ url, type }) {
            ...
            if (exists) return;
            this.resources.unshift({ url, type: normalizedType, name: Utils.getFilename(url) });
        ...
        _renderResourceList() {
            ...
            this.resources.forEach((item, idx) => {
                ...
                const tag = Utils.createElement('span', { class: 'tag ' + item.type }, item.type.toUpperCase());
        ...
        _refreshResourceSelect() {
            ...
            this.resources.filter(r => r.type === 'm3u8').forEach(r => {
